...
class DataSets:
    ...
    def __init__(self):
        ...
        self.wip_test = None
        self.all_counts = None  # Dict with fleet, condition_f, depot, condition_a DataFrames
        self.all_ac_df = None
    ...
    def build_part_ac_df(self, get_parts_df_func, compute_fleet_count_over_time, compute_all_counts_over_time, get_ac_df_func, get_log_dataframe):
        """
        ...
        self.wip_test = compute_fleet_count_over_time()
        self.all_counts = compute_all_counts_over_time()  # Dict: fleet, condition_f, depot, condition_a
